...
public abstract class ProgramTest {
     ...
     */
    @Test
    public final void testName2OneInstruction() {
        /*
         * Setup
         */
     ...
     */
    @Test
    public final void testSetName2OneInstruction() {
        Program pTest = this.createFromFileTest(FILE_NAME_2);
        Program pRef = this.createFromFileRef(FILE_NAME_2);
        String newName = "Replacement";
        pRef.setName(newName);
     ...
     */
    @Test
    public final void testNewContext2OneInstruction() {
        Program pTest = this.createFromFileTest(FILE_NAME_2);
        Program pRef = this.createFromFileRef(FILE_NAME_2);
        Map<String, Statement> cRef = pRef.newContext();
        Map<String, Statement> cTest = pTest.newContext();
     ...
     */
    @Test
    public final void testSwapContext2OneInstruction() {
        Program pTest = this.createFromFileTest(FILE_NAME_2);
        Program pRef = this.createFromFileRef(FILE_NAME_2);
        Map<String, Statement> contextRef = pRef.newContext();
        Map<String, Statement> contextTest = pTest.newContext();
     ...
     */
    @Test
    public final void testNewBody2OneInstruction() {
        Program pTest = this.createFromFileTest(FILE_NAME_2);
        Program pRef = this.createFromFileRef(FILE_NAME_2);
        Statement bRef = pRef.newBody();
        Statement bTest = pTest.newBody();
     ...
     */
    @Test
    public final void testSwapBody2OneInstruction() {
        Program pTest = this.createFromFileTest(FILE_NAME_2);
        Program pRef = this.createFromFileRef(FILE_NAME_2);
        Statement bodyRef = pRef.newBody();
        Statement bodyTest = pTest.newBody();
     ...
     */
    @Test
    public final void testName3NoInstruction() {
        /*
         * Setup
         */
     ...
     */
    @Test
    public final void testSetName3NoInstruction() {
        Program pTest = this.createFromFileTest(FILE_NAME_3);
        Program pRef = this.createFromFileRef(FILE_NAME_3);
        String newName = "Replacement";
        pRef.setName(newName);
     ...
     */
    @Test
    public final void testNewContext3NoInstruction() {
        Program pTest = this.createFromFileTest(FILE_NAME_3);
        Program pRef = this.createFromFileRef(FILE_NAME_3);
        Map<String, Statement> cRef = pRef.newContext();
        Map<String, Statement> cTest = pTest.newContext();
     ...
     */
    @Test
    public final void testSwapContext3NoInstruction() {
        Program pTest = this.createFromFileTest(FILE_NAME_3);
        Program pRef = this.createFromFileRef(FILE_NAME_3);
        Map<String, Statement> contextRef = pRef.newContext();
        Map<String, Statement> contextTest = pTest.newContext();
     ...
     */
    @Test
    public final void testNewBody3NoInstruction() {
        Program pTest = this.createFromFileTest(FILE_NAME_3);
        Program pRef = this.createFromFileRef(FILE_NAME_3);
        Statement bRef = pRef.newBody();
        Statement bTest = pTest.newBody();
     ...
     */
    @Test
    public final void testSwapBody3NoInstruction() {
        Program pTest = this.createFromFileTest(FILE_NAME_3);
        Program pRef = this.createFromFileRef(FILE_NAME_3);
        Statement bodyRef = pRef.newBody();
        Statement bodyTest = pTest.newBody();
     ...
     */
    @Test
    public final void testName4EmptyBody() {
        /*
         * Setup
         */
     ...
     */
    @Test
    public final void testSetName4EmptyBody() {
        Program pTest = this.createFromFileTest(FILE_NAME_4);
        Program pRef = this.createFromFileRef(FILE_NAME_4);
        String newName = "Replacement";
        pRef.setName(newName);
     ...
     */
    @Test
    public final void testNewContext4EmptyBody() {
        Program pTest = this.createFromFileTest(FILE_NAME_4);
        Program pRef = this.createFromFileRef(FILE_NAME_4);
        Map<String, Statement> cRef = pRef.newContext();
        Map<String, Statement> cTest = pTest.newContext();
     ...
     */
    @Test
    public final void testSwapContext4EmptyBody() {
        Program pTest = this.createFromFileTest(FILE_NAME_4);
        Program pRef = this.createFromFileRef(FILE_NAME_4);
        Map<String, Statement> contextRef = pRef.newContext();
        Map<String, Statement> contextTest = pTest.newContext();
     ...
     */
    @Test
    public final void testNewBody4EmptyBody() {
        Program pTest = this.createFromFileTest(FILE_NAME_4);
        Program pRef = this.createFromFileRef(FILE_NAME_4);
        Statement bRef = pRef.newBody();
        Statement bTest = pTest.newBody();
     ...
     */
    @Test
    public final void testSwapBody4EmptyBody() {
        Program pTest = this.createFromFileTest(FILE_NAME_4);
        Program pRef = this.createFromFileRef(FILE_NAME_4);
        Statement bodyRef = pRef.newBody();
        Statement bodyTest = pTest.newBody();
