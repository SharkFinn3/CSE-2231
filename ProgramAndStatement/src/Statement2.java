...
public class Statement2 extends StatementSecondary {
    ...
    private void createNewRep() {
        ...
        //new tree1 representation
        this.rep = new Tree1<StatementLabel>();
        Sequence<Tree<StatementLabel>> childNodes = this.rep
                .newSequenceOfTree();
        //statement label for the root of tree
        StatementLabel parentNode = new StatementLabel(Kind.BLOCK);
        //assemble all of the nodes in the tree; parent and children
        this.rep.assemble(parentNode, childNodes);
    }
    ...
    public final Kind kind() {
        ...
        //returns kind of root representation
    ...
    public final void addToBlock(int pos, Statement s) {
        ...
        //create children with new sequence of tree
        Sequence<Tree<StatementLabel>> childNodes = this.rep
                .newSequenceOfTree();
        //get root of tree
        StatementLabel parent = this.rep.disassemble(childNodes);
        Statement2 sRep = (Statement2) s;
        childNodes.add(pos, sRep.rep);
        //reassemble tree
        this.rep.assemble(parent, childNodes);
        //clear sRep
        sRep.createNewRep();
    }
    ...
    public final Statement removeFromBlock(int pos) {
        ...
        Sequence<Tree<StatementLabel>> childNodes = this.rep
                .newSequenceOfTree();
        StatementLabel parent = this.rep.disassemble(childNodes);
        //remove nodes at position pos
        s.rep = childNodes.remove(pos);
        //restore rep
        this.rep.assemble(parent, childNodes);
        return s;
    }
    ...
    public final int lengthOfBlock() {
        ...
        //return number of subtrees of the representation
    ...
    public final void assembleIfElse(Condition c, Statement s1, Statement s2) {
        ...
        Statement2 s1m2 = (Statement2) s1;
        Statement2 s2m2 = (Statement2) s2;
        StatementLabel l = new StatementLabel(Kind.IF_ELSE, c);
        Sequence<Tree<StatementLabel>> childNodes = this.rep
                .newSequenceOfTree();
        childNodes.add(0, s1m2.rep);
        childNodes.add(1, s2m2.rep);
        this.rep.assemble(l, childNodes);
        s1m2.createNewRep();
        s2m2.createNewRep();
    }
    ...
    public final Condition disassembleIfElse(Statement s1, Statement s2) {
        ...
        Sequence<Tree<StatementLabel>> childNodes = this.rep
                .newSequenceOfTree();
        StatementLabel l = this.rep.disassemble(childNodes);
        s1m2.rep = childNodes.remove(0);
        s2m2.rep = childNodes.remove(0);
        this.createNewRep();
        return l.condition;
    }
    ...
    public final void assembleWhile(Condition c, Statement s) {
        ...
        StatementLabel l = new StatementLabel(Kind.WHILE, c);
        Sequence<Tree<StatementLabel>> childNodes = this.rep
                .newSequenceOfTree();
        childNodes.add(0, s2.rep);
        this.rep.assemble(l, childNodes);
        s2.createNewRep();
    }
    ...
    public final void assembleCall(String inst) {
        ...
        StatementLabel l = new StatementLabel(Kind.CALL, inst);
        Sequence<Tree<StatementLabel>> childNodes = this.rep
                .newSequenceOfTree();
        this.rep.assemble(l, childNodes);
    }
