...
public class Program2 extends ProgramSecondary {
    ...
    public final void swapContext(Map<String, Statement> c) {
        ...
        // TODO - fill in body
        Map<String, Statement> newCtxt = c.newInstance();
        newCtxt.transferFrom(c);
        c.transferFrom(this.context);
        this.context.transferFrom(newCtxt);
    }
    ...
    public final void swapBody(Statement b) {
        ...
        // TODO - fill in body
        Statement newBody = b.newInstance();
        newBody.transferFrom(b);
        b.transferFrom(this.body);
        this.body.transferFrom(newBody);
    }
