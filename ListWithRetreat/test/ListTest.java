...
public abstract class ListTest {
    ...
    /**
     * Routine test case for retreat.
     */
    @Test
    public final void testRetreatLeftNonEmptyLargeRightEmpty() {
        /*
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(4, "red", "yellow", "blue",
                "orange");
        List<String> list2 = this.createFromArgsRef(3, "red", "yellow", "blue",
                "orange");
        /*
         * Call method under test
         */
    ...
    /**
     * Boundary test case for retreat.
     */
    @Test
     ...
     */
    @Test
    public final void testRetreatLeftNonEmptyRightNonEmptyLarge() {
        /*
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(2, "red", "yellow", "blue",
                "orange", "green");
        List<String> list2 = this.createFromArgsRef(1, "red", "yellow", "blue",
                "orange", "green");
        /*
         * Call method under test
         */
    ...
    /**
     * Challenging test case for retreat.
     */
    @Test
    public final void testRetreatLeftNonEmptyLargeRightNonEmptyLarge() {
        /*
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(4, "red", "yellow", "blue",
